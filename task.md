...
| remove-git-folder              | [path]               | Remove git folders in path.                                  |
| remove-git-submodule           | [path]               | Remove a git submodule.                                      |
| ls-git-folder                  | [grep]               | List git folders path space separated.                       |
| reset-git-folder               |                      | Abort rebase and reset submodules from the .gitmodules file. |
| stage-git-folder               | [path]               | Stage all files in git folders in path.                      |
| switch-git-folder              | [version]            | Switch branch for all git folders from the .gitmodules file. |
...
| test-odoo-version-regex        |                      | Test the Odoo module version regex filter.                   |
|--------------------------------|----------------------|--------------------------------------------------------------|
...
| clear-filestore                | [db]                 | Clear local filestore folder.                                |
...
| import-csv                     | [db][path]           | Import data from csv. Filename is PostgreSQL table name.     |
...
| get-modules                    | [path][option]       | Get list of modules in path. 'basename' or 'dirname'.        |
...
| start                          | [name][db]           | Start service. Use list to show services.                    |
...
| test-project                   | [cleanup]            | Run tests for this project.                                  |
| version                        |                      | Show version of required tools.                              |
|--------------------------------|----------------------|--------------------------------------------------------------|
| record-with-memray             | [name]               | Record application memory usage with memray.                 |
