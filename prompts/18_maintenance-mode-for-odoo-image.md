...
I want to run the Odoo container in a maintenance mode. Similar to `odoo-nignx` I want to have a `nginx-maintenance` in `images/odoo/entrypoint.sh`.

The page `images/odoo/maintenance.html` must be copied to `/etc/nginx/conf.d/static`.
