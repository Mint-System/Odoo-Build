...
```
Source: [snippets/l10n_din5008.external_layout_din5008.footer_lapp_xinomer.xml](https://github.com/Mint-System/Odoo-Build/tree/16.0/snippets/l10n_din5008.external_layout_din5008.footer_lapp_xinomer.xml)
            ...
            <div class="information_block">
                ...
                <table>
                    ...
                    <t t-if="o._name == 'stock.picking'">
                        ...
                        <tr>
                            <td>
                                <span>Ihr Auftrag</span>
                            </td>
                            <td>
                                <span t-field="o.x_client_order_ref"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
