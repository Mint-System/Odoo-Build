...
### Add Address Space Copy  
ID: `mint_system.stock.report_delivery_document.add_address_space copy`  
```xml
<?xml version="1.0"?>
...
```
Source: [snippets/stock.report_delivery_document.add_address_space copy.xml](https://github.com/Mint-System/Odoo-Build/tree/14.0/snippets/stock.report_delivery_document.add_address_space copy.xml)
...
## Xml  
### *  
ID: `mint_system.stock.xml.*`  
```xml

```
Source: [snippets/stock.xml.*.xml](https://github.com/Mint-System/Odoo-Build/tree/14.0/snippets/stock.xml.*.xml)
