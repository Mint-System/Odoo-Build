...
ID: `mint_system.base.contact_name.add_negative_space`\
...
<data priority="52">
    ...
    <xpath expr="//notebook/page/field/form/sheet/group/group/field[@name='function']" position="after">
...
ID: `mint_system.base.view_partner_form.hide_partner_ledger`\
Inherit ID: `base.view_partner_form`
...
ID: `mint_system.base.view_partner_tree.show_first_last_name`\
Inherit ID: `base.view_partner_tree`
...
ID: `mint_system.base.view_view_form.show_website_id`\
Inherit ID: `base.view_view_form`
...
<data priority="50">
    ...
    <xpath expr="//list/field[@name='xml_id']" position="after">
        <field name="website_id"/>
    </xpath>
</data>
